...
Order.create(product_ir:3, info:'Information3', quantity:5, orderdate:'2016/28/10' )
Order.create(product_ir:2, info:'Information4', quantity:23, orderdate:'2016/30/10' )
